namespace Lab.UI.Keys
{
    public static class LabUIRouteKeys
    {
        ...
        [UIRouteDefinition] public const string InGame = "lab/ui/in-game";
    ...
    public static class LabUIActionKeys
    {
        ...
        public static readonly UIActionKey OpenInGame = UIActionKeyRegistry.Get(LabUIRouteKeys.InGame);
    ...
    {
        [UIScreenKey]
        public static ScreenKey Title = new(LabUIRouteKeys.Title);
    
        [UIScreenKey]
        public static ScreenKey InGame = new(LabUIRouteKeys.InGame);
    
        [UIScreenKey]
        public static ScreenKey Dialogue = new(LabUIRouteKeys.Dialogue);
    }
}